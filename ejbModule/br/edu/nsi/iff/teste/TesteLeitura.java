...
//		String uid = "1";
	...
	public static Leitura popularinsert(Pontosmontagen pontosmontagen, Timestamp datahora){
		UUID uuid = UUID.randomUUID();
		String uid = uuid.toString();
...
//		String uid = "1";
		...
		instanceLeitura.insert(pontosmontagen, uid, datahora, deslocamento, rmspicos, rmsruido, rmstotal, rotacao);
		System.out.println("insert leitura");
		
		return instanceLeitura.find(uid);
	}
}
